  ...
  return (
    <>
      ...
      <section className='text-left m-4 space-y-4 py-6 lg:py-10'>
        ...
        <p>Après un récent stage sur des projets d’application web et mobile, en collaborant à distance avec une équipe de développeurs, je souhaite continuer avec une alternance en Conception et Développement d’Applications (niveau Bac+3/4) option Éco-conception, une approche qui m'intéresse particulièrement. En effet, je suis soucieuse de l'empreinte carbone générée par les sites que je développe et je désire approfondir mes compétences dans ce domaine pour trouver des solutions plus responsables et durables.</p>
