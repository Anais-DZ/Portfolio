            ...
            <div className="lg:hidden">
                ...
                {isNavOpen && (
                    <div className="fixed top-0 left-0 w-full h-full bg-black/50 z-40">
                        <div
                            ref={overlayRef}
                            className="fixed top-0 left-0 w-full h-[80vh] bg-gray-800 backdrop-blur-md flex flex-col items-center justify-center transition-transform duration-500 ease-out z-50"
                        >
                            {/* Bouton Fermer */}
                            <button
